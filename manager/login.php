...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $sid > 0) {
    ...
    $q = $db->prepare(
        'SELECT * FROM managers WHERE username = ? AND school_id = ?'
    );
...
<p class="lead">
    Step 1 of 2: select your school first.
</p>
...
<?php
    ...
    if (!$school) {
        ...
        echo '<div class="msg bad">School not found.</div>';
...
<div class="card narrow">
    ...
    <p class="lead">
        Step 2 of 2: enter your login details.
    </p>
